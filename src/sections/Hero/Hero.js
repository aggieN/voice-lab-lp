        ...
        <Wrapper>
          <div className={styles.container}>
            <div className={styles.box}>
              ...
              <button className={styles.buttonDesktop}>zapisz się na darmową konsultację</button>
            </div>
            ...
            <button className={styles.buttonMobile}>zapisz się na darmową konsultację</button>
          </div>
        </Wrapper>
      </div>
    </section>
